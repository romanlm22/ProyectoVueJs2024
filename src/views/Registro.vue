                  ...
                  <form>
                      ...
                      <div class="form-check mb-3">
                          ...
                          <label class="form-check-label" for="terms">
                              Acepta los terminos y condiciones <router-link class="text-decoration-none" to="/about">Terminos y Coondiciones</router-link>
                          </label>
                      </div>
                      <button type="submit" class="btn btn-primary w-100">Registro</button>
                  </form>
                  <div class="text-center mt-3">
                      <p class="mb-0">Ya tiene cuenta? <router-link class="text-decoration-none" to="/Login">Iniciar Sesion</router-link></p>
                  </div>
              </div>
          </div>
      </div>
